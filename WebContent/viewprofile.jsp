<%@ page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8" import="entity.*, java.util.*, myutil.*, dao.UserDao"%>
<!DOCTYPE html>
	<head>
		<meta charset="utf-8">	
		...
		<div class="main">
		  <div class="container">
		    <div class="row">
		      <div class="col-md-3">
		        <!-- Left column -->
		        <a href="#" class=""><strong><i class="glyphicon glyphicon-user"></i> <%= user.getFirstName() %>' Profile</strong></a>
		        <hr class="">
		        <div class="profile-box">
		          <div class="profile-cover-image">
		            <img src="<%=user.getPhoto() %>" class="">
		          </div>
		          <div class="profile-picture">
		            <img src="<%=user.getPhoto() %>" class="">
		          </div>
		          <div class="profile-content">
		            <h1 class=""><%=user.getFirstName()+ " "+ user.getLastName() %></h1>
		            
		            <p class=""><%=user.getEmail()%>
		            	<%
